...
File này chứa thông tin OAuth client — **không có trong repo** (bảo mật). Tạo file `credentials.json` ở thư mục gốc repo với nội dung sau:

```json
{
  "installed": {
    "client_id": "THAY_CLIENT_ID_VAO_DAY",
    "project_id": "mcp-appscript-sheet",
...
**BÁO CHO NGƯỜI DÙNG:** "Bạn cần hỏi quản trị viên (Thảo Anh) lấy client_id và client_secret để điền vào. Hoặc nếu bạn đã được gửi file credentials.json riêng, copy vào thư mục maru-sheets-mcp."
